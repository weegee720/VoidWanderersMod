...
i = #CF_ItmNames[factionid] + 1
CF_ItmNames[factionid][i] = "MP5K"
CF_ItmPresets[factionid][i] = "MP5K"
CF_ItmModules[factionid][i] = "Ronin.rte"
CF_ItmPrices[factionid][i] = 40
CF_ItmDescriptions[factionid][i] = "Automatic sidearm with a high rate of fire and quick reload time.  The MP5K can be wielded with a shield."
CF_ItmUnlockData[factionid][i] = 1000
CF_ItmTypes[factionid][i] = CF_WeaponTypes.PISTOL;
